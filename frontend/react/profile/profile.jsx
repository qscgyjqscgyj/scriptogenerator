                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control"
                                               ...
                                               value={usersStore.session_user.last_name ? usersStore.session_user.last_name : ''}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control"
                                               ...
                                               value={usersStore.session_user.first_name ? usersStore.session_user.first_name : ''}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control"
                                               ...
                                               value={usersStore.session_user.middle_name ? usersStore.session_user.middle_name : ''}
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" disabled={true}
                                               defaultValue={usersStore.session_user.email} type="text" name="email"
                                               placeholder="Email"/>
                                    </div>
                                    <div className="form-group">
                                        <label>Телефон</label>
                                        <MaskedInput mask="+7 111 111 1111" name="phone" size="20"
                                                     ...
                                                     onChange={(e) => usersStore.session_user.phone = e.target.value}
                                                     placeholder="Телефон"/>
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input className="form-control"
                                               ...
                                               value={usersStore.session_user.company ? usersStore.session_user.company : ''}
